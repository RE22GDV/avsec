...
> `fe45d509310b99d4`, коміт `8014cd9`, робоче дерево чисте. Середовище:
...
| ---: | ---: | ---: | ---: |
| 0,00 | 100,00 % | 100,00 % | — |
| **0,25** | **12,69 %** | **99,71 %** | **87,0 в. п.** |
| 1,00 | 3,88 % | 98,33 % | 94,5 в. п. |
| 2,00 | 0,70 % | 93,72 % | 93,0 в. п. |
| 4,00 | 0,09 % | 77,21 % | 77,1 в. п. |
| 8,00 | 0,02 % | 45,57 % | 45,6 в. п. |

<sub>Частка пікселів, відновлених точно. Джерело:
<a href="img/luma_noise_deep.csv">luma_noise_deep.csv</a>.</sub>

Точний пошук розсипається одразу: вже за σ = 0,25 рівня він відновлює 12,69 %
пікселів, бо шифротекст майже ніде не збігається з кодовим словом побайтово.
Декодування за найближчим у той самий момент дає 99,71 %. **Це рішення
...
| ---: | ---: | ---: | ---: |
| 0,5 | 33,65 дБ | 35,95 дБ | 34,95 дБ |
| 1,0 | 26,57 дБ | 36,12 дБ | 27,24 дБ |
| 2,0 | **20,66 дБ** | 25,79 дБ | 29,34 дБ |
| 4,0 | 15,56 дБ | **19,54 дБ** | **10,70 дБ** |
| 8,0 | 12,13 дБ | 14,33 дБ | 10,28 дБ |
...
майже нешкідливий (29,34 дБ), а між 2 і 4 обвалюється до 10,70 дБ. Причина в
...
Ядро завширшки **два відліки** знищує схему: 6,83 % відновлених пікселів і
10,33 дБ. Причина безпосередня: повідомлення живе виключно в кольоровості, а
...
числа (93,26 % проти 93,23 % за чотирьох рядків): непошкоджені пікселі
...
| 1 | 27,08 дБ | 98,40 % | поодинокі різкі точки |
| 2 | 20,62 дБ | 93,61 % | помітний «сніг», сюжет читається повністю |
| 4 | 15,55 дБ | 77,16 % | щільний «сніг», великі об'єкти ще впізнавані |
| 8 | 12,08 дБ | 45,10 % | сюжет ледве вгадується |
| 16 | 10,50 дБ | 18,24 % | зображення не читається |
...
значення зростає з 0,16 рівня за σ = 0,25 до 58,11 рівня за σ = 16 — тобто
...
| 0 | Cb | 73,000 | −0,0116 | 0,56 % |
| 1 | яскравість | 0,804 | +0,0056 | 0,84 % |
| 2 | яскравість | 1,407 | +0,0003 | 0,56 % |
| 4 | яскравість | 2,713 | +0,0072 | 0,28 % |
| 8 | яскравість | 5,363 | −0,0025 | 0,56 % |
| 16 | яскравість | 10,609 | +0,0004 | 0,56 % |
| 16 | Cb | 57,506 | −0,0111 | 0,84 % |
...
зростає з нуля до 10,609, але кореляція з вихідним кадром лишається в межах
±0,007, а безключова атака дає від 0,28 до 0,84 % правильних сусідств — тобто
...
| Дрейф підсилення й зміщення | сила 2 | **раптовий**: між 2 і 4 падіння на 18,6 дБ |
| **Смуга кольоровості** | **не долає порога взагалі** | **раптовий**: ядро 2 відліки дає 10,33 дБ |
...
4. **Схема не витримує звуження смуги кольоровості.** Ядро завширшки два
   відліки дає 10,33 дБ. Оскільки в композитному сигналі смуга кольоровості
