...
Незалежно від цього ланцюга постає інше питання: чи можна побудувати
шифротекст так, щоб **монохромний** спостерігач не бачив нічого взагалі. `B2l`
...
Питання поставлено не всередині ланцюга `B1 → B2 → B2s`, а незалежно від
нього, тому схема є відгалуженням, а не наступним кроком, і має власний стенд
та власний документ — [luma_balance.md](luma_balance.md). Тут наведено виклад, узгоджений за складом
