...
<!-- DOCNAV -->
> **Що це.** Паспорт кожного набору: походження, ліцензії, спосіб виготовлення
> кліпів, одиниця незалежності та межі того, що на ньому можна довести.
>
> **Кому.** Перш за все — тому, хто оцінює, наскільки висновки узагальнюються.
>
> **Поруч:** [протокол експериментів](experiments.md) · [реєстр тверджень](claims.md) · [road map](../ROADMAP.md) · [README](../README.md)
<!-- /DOCNAV -->
...
[R07](defects_r01_r12.md#r07-сімнадцять-вирізок-з-однієї-фотографії-рахувалися-як-сімнадцять-джерел)).
